 ...
 * the total behaviour BDD. At the initialization phase, it also receives
 * information about the glue, sends this to the glue encoder and orders it to
 * compute the glue BDD. During each execution cycle, it receives information
 * about the current state of the BIP components and their disabled ports, sends
 * this to the current state encoder and orders it to compute the current state
 * BDDs. When a new interaction is chosen by the engine, it notifies all the BIP
 * components.
 * 
 * @author mavridou
 */
...
public interface BIPCoordinator extends BIPEngine, InteractionExecutor, BIPEngineStarter {
	...
	/**
	 * Returns the BIP component instances registered in the system that
	 * correspond to the component type provided as a parameter.
	 *
	 * @param type
	 *            the type
	 * @return arrayList of component instances that correspond to this
	 *         component type.
	...
	/**
	 * Returns the total number of ports of registered component instances in
	 * the system.
	 * 
	...
	/**
	 * Returns the total number of states of registered component instances in
	 * the system.
	 * 
	...
	/**
	 * Set the interaction Execute instance either as DataCoordinator or as
	 * BIPCoordinator depending on whether there are data transfer between the
	 * components or not respectively.
	 *
	...
	void setDataInformer(DataInformer informer);
